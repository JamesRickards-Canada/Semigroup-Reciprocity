...
/*thin.c*/
  ...
  addhelp(semigroup_mgens,"semigroup_mgens(mats): returns a minimal set of generators for the semigroup generated by mats. We assume that these matrices have all nonnegative entries, and remove the identity element if it occurs.");
